  ...
  build:
    ...
    steps:
      ...
      - name: Create a Release
        ...
        run: npx semantic-release
        evv:
          GITHUB_TOKEN: ${{ secrets.GITHUB-TOKEN }}   #this token is already generated by github. or you can create your own secret, with your github token and name it like ABHI-GITHUB-TOKEN, so when  it will make the release note, your name will be there.
      - name: install the 'surge' to Deploy the our build
        run: npm install -g surge
